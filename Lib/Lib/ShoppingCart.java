package Lib;
/**
* ADT(Mutable) สามารถปรับเปลี่ยนได้ สำหรับตะกร้าสินค้า
* เก็บรายการสินค้าแบบ CartItem และคำนวนราคาทั้งหมดได้จาก PricingService
*/
...
public class ShoppingCart {
    ...
    //RI: item != null และไม่มี CartItem ที่ product เป็น null หรือ quantity <=0
    // pricingService != null
    //catalog != null
    //AF: AF(items, pricingService, catalog) = ตพกร้าสินค้าที่มีรายการสินค้าทัั้งหมด
    //items  ที่สามารถคำนวนราคารวมโดยใช้ pricingService  และดึงข้อมูลสินจากได้จาก catalog

    /**
     * สร้างตะกร้าสินค้าใหม่  โดยต้องมี PricongService , ProductCatalog ที่ไม่เป็น null
     * @param pricingService ตัวคำราคาสินค้า, catalog แหล่งข้อมูลของสืนค้า
     */
